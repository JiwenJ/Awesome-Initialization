...
> A companion collection on Hyperball, AdamH, MuonH, their analyses, implementations, and applications. Snapshot: **2026-09-19**.
...
The search covered public sources through **2026-09-19**, including arXiv version histories and full text, bioRxiv metadata, OpenReview records, author and institutional pages, and GitHub code/logs. It followed Hyperball, AdamH, MuonH, SGDH, HyperP, HyperTransfer, nGPT, νGPT, and the Fantastic Pretraining Optimizers II / 2.1 / 2.2 aliases. The latest directly verified Hyperball paper is HyperTransfer, first submitted September 7; the September 15–19 incremental search found no later qualifying record. Indexed search cannot establish absolute completeness.

See the [full search audit](hyperball-search-audit-2026-09-14.md) and [September 19 incremental audit](hyperparameter-transfer-search-audit-2026-09-19.md) for inclusion decisions, version issues, and unresolved artifacts. Graph-centrality HyperBall, geometric ball packing, generic “hyperball” terminology, games, mirrors, and automatic paper summaries are outside this optimizer collection. Follow [CONTRIBUTING.md](../CONTRIBUTING.md) when adding entries.
