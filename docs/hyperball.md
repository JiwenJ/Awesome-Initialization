...
> A companion collection on Hyperball, AdamH, MuonH, their analyses, implementations, and applications. Snapshot: **2026-09-20**.
...
The search covered public sources through **2026-09-20**, including arXiv version histories and full text, bioRxiv metadata, OpenReview records, author and institutional pages, and GitHub code/logs. It followed Hyperball, AdamH, MuonH, SGDH, sphere-constrained Muon variants, HyperP, HyperTransfer, nGPT, νGPT, and the Fantastic Pretraining Optimizers II / 2.1 / 2.2 aliases. A September 20 citation and full-text check recovered the August 28 MuonM paper because it directly compares tuned MuonH and develops a related learnable-radius sphere method. HyperTransfer, first submitted September 7, remains the latest directly verified paper by first-public date. Indexed search cannot establish absolute completeness.

See the [full search audit](hyperball-search-audit-2026-09-14.md), [September 19 incremental audit](hyperparameter-transfer-search-audit-2026-09-19.md), and [September 20 correction audit](hyperball-search-audit-2026-09-20.md) for inclusion decisions, version issues, and unresolved artifacts. Graph-centrality HyperBall, geometric ball packing, generic “hyperball” terminology, games, mirrors, and automatic paper summaries are outside this optimizer collection. Follow [CONTRIBUTING.md](../CONTRIBUTING.md) when adding entries.
